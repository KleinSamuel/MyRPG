...
public class MyOrthogonalTileMapRenderer extends BatchTiledMapRenderer {

    private float[] vertices = new float[20];

    public MyOrthogonalTileMapRenderer(TiledMap map) {
        super(map);
    }

    public MyOrthogonalTileMapRenderer(TiledMap map, float unitScale) {
        super(map, unitScale);
    }
